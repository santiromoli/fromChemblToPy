% run startup.m prior
% activity estimator for TAS-120
clear all, close all
clc
...
%retardo = 1; %defino el retardo

%xd = delay(xent,retardo);           %calculo los vectores retardados
...
covfunc = {'covSum',{SE,NO,LIN,CONS}};      %definition of covariance function
